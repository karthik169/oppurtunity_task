document.addEventListener("DOMContentLoaded", function() {
        ...
        // ✅ ALL OTHER FUNCTIONS HERE (OUTSIDE)
        function showPage(pageId) { /* keep your code */ }
        function togglePass() { /* keep */ }
        function showError() { /* keep */ }
        function clearAllErrors() { /* keep */ }
        function shakeForm() { /* keep */ }
        function isValidEmail() { /* keep */ }
        function showToast() { /* keep */ }
        function showDashboard(email) { /* keep */ }
        function handleLogout() { /* keep */ }
    
    
        // ✅ LOGIN EVENT (ONLY LOGIN LOGIC HERE)
